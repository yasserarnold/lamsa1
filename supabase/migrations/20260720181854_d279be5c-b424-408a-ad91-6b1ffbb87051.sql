-- فهارس لتسريع صفحات لوحة التحكم والمشرف والاستعلامات الأكثر تكراراً.
...
CREATE INDEX IF NOT EXISTS idx_profiles_username_published ON public.profiles (username) WHERE is_published = true;